...
export const ChooseChartModal = (props: ChooseChartModalProps) => {
  const [selectedChartType, doSetSelectedChartType] =
  ...
  const isRecommended = (chartType: ChartType) =>
    props.recommendedCharts.some(
      (recommendation: ChartType) => recommendation === chartType,
    );
  ...
  return (
    ...
    >
      {props.uploadedData.wasDataModified ? (
        <InlineNotification {...warningNotificationProps} />
      ) : null}
      <p>
        Choose a type of chart and click done to start editing your new chart
      </p>
      <div className={chartOptions}>
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.SIMPLE_BAR_CHART);
          }}
          icon={<img alt="" src={simpleBarIcon} />}
          selected={
            selectedChartType === ChartType.SIMPLE_BAR_CHART && !horizontal
          }
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.SIMPLE_BAR_CHART, true);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.SCATTER_CHART);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.DONUT_CHART);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.STACKED_BAR_CHART);
          }}
          icon={<img alt="" src={stackedBarIcon} />}
          selected={
            selectedChartType === ChartType.STACKED_BAR_CHART && !horizontal
          }
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.STACKED_BAR_CHART, true);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.LINE_CHART);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.AREA_CHART);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.STACKED_AREA_CHART);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.GROUPED_BAR_CHART);
          }}
          icon={<img alt="" src={groupedBarIcon} />}
          selected={
            selectedChartType === ChartType.GROUPED_BAR_CHART && !horizontal
          }
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.GROUPED_BAR_CHART, true);
          }}
        ...
        <SelectionTile
          styles={chartOptionTile}
          onChange={() => {
            setSelectedChartType(ChartType.PIE_CHART);
          }}
