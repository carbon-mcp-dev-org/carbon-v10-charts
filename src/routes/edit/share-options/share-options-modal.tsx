...
export const ShareOptionsModal = ({ chart }: any) => {
  ...
  const [shareOptionsState, setShareOptionsState] =
    useState<ShareOptionsModalState>({
          ...
          >
            <div className={exportOptionsWrapper}>
              <SelectionTile
                ...
                icon={<Code size={32} />}
                selected={
                  shareOptionsState.selectedExportOption === Exports.CODE
                }
                label="Code"
              />
              <SelectionTile
                ...
                icon={<Image size={32} />}
                selected={
                  shareOptionsState.selectedExportOption === Exports.IMAGE
                }
                label="Image"
              />
            </div>
