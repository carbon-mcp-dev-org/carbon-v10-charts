...
import { Col, LinkButton, Main, Row } from "./../components";
  ...
  if (name === "upload") {
    return (
      <>
        ...
        <div className={placeholder}>uploader</div>

        <FormLabel className={marginTop()}>Mapping</FormLabel>
        <div className={placeholder}>mapping of cols/rows to fields</div>
      </>
    );
  }
  ...
  if (name === "api") {
    return (
      <>
        ...
        <CodeSnippet>
          https://carbon-charts-builder.ibm.com/api/upload/eGVub24gaXMgYXdlc29tZQ==
        </CodeSnippet>

        <FormLabel className={marginTop()}>Get started</FormLabel>
        <div className={placeholder}>how to use endpoint</div>

        <FormLabel className={marginTop()}>Mapping</FormLabel>
        <div className={placeholder}>declaration of availiable fields</div>
      </>
    );
  }
  return null;
      ...
      <Row>
        <Col cols={{ sm: 2 }}>
          ...
          <Form className={marginTop()}>
            ...
            <LinkButton className={marginTop()} kind="secondary" to="/data">
              Cancel
            </LinkButton>
